...
public class UmamusumeTLMModel extends BedrockModel<Mob> {
	...
	public UmamusumeTLMModel(BedrockModelPOJO pojo) {
		...
		this.head = this.getModelMap().get("head");
	...
	@Override
	public void setupAnim(Mob entityIn, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw,
			float pHeadPitch) {
